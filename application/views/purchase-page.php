...
<html xmlns="http://www.w3.org/1999/xhtml">
 ...
 <?php require_once(APPPATH . 'views/css-page.php'); ?>
        ...
        <script type='text/javascript' src='<?= base_url(); ?>js/example.js'></script>
                            ...
                            foreach ($items as $loop) {
                                ...
                                <div class="infobox infobox-blue  ">
                                    <div class="infobox-icon">
                                       <?php  echo '<img height="50px" width="50px" src="data:image/jpeg;base64,' . $loop->image . '" />';?>
                                    </div>

                                    <div class="infobox-data">
                                        <span class="infobox-data-number"><?php echo  $loop->quantity; ?></span>
                                        <div class="infobox-content"> <?php echo $loop->name; ?></div>
                                    </div>

                                    <div class="badge badge-success">
                                        <?php echo number_format( $loop->sale_price); ?>
...
Phone: (555) 555-5555</textarea>
                        ...
                        <div id="logo">
                            ...
                            <img id="image" src="<?= base_url(); ?>images/logo.png" alt="logo" />
                        </div>
    ...
    $(function () {
        $("#btnadd").click(function () {
            ...
            for (var i = 1; i < n; i++) {
                ...
                var description = $("table").find("tr").eq(i).find("td").eq(2).text();
                var cost = $("table").find("tr").eq(i).find("td").eq(3).text();
                //alert(salary);
                $.ajax({
                    type: "Post",
                    url: "<?php echo base_url() . "index.php/billing/create"; ?>",
