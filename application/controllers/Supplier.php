...
class Supplier extends CI_Controller {
    ...
    public function index() {
        ...
        $this->load->view('view-supplier', $data);
    }
    ...
    public function create() {
        ...
        //user information
        // $clientID = $this->GUID();
        $query = $this->Md->query("SELECT * FROM supplier WHERE contact='" . $this->input->post('contact') . "'");
        ...
        if ($this->input->post('name') != "") {
            ...
            $userfile = $data['file_name'];
            $id = $this->GUID();
            $supplier = array('id'=>  $id,'name' => $this->input->post('name'), 'contact' => $this->input->post('contact'), 'image' => $userfile, 'created' => date('Y-m-d H:i:s'), 'category' => $this->input->post('category'));
            $this->Md->save($supplier, 'supplier');
        ...
        if (!empty($_POST)) {
            ...
            foreach ($_POST as $field_name => $val) {
                ...
                if (!empty($user_id) && !empty($field_name) && !empty($val)) {
                    ...
                    $this->Md->update_dynamic($user_id, 'id', 'supplier', $task);
                    echo "Updated";
                } else {
    ...
    public function delete() {
        ...
        $query = $this->Md->cascade($id, 'supplier', 'id');
